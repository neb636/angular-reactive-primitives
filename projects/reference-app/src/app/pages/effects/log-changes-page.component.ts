  ...
  template: `
    <documentation>
      ...
      <documentation-section>
        ...
        <code-block title="Basic Logging" [code]="code_usage_0" />

        <code-block title="Multiple Log Levels" [code]="code_usage_1" />

        <code-block title="Debugging Complex State" [code]="code_usage_2" />

        <code-block title="Conditional Logging" [code]="code_usage_3" />
      </documentation-section>
...
// [2025-10-28T12:34:56.789Z] Theme: dark`;
  ...
  code_usage_3 = `import { Component, signal, effect } from '@angular/core';
import { logChangesEffect } from 'angular-reactive-primitives';
