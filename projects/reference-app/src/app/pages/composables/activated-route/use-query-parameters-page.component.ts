...
} from './use-query-parameters-page.code';
  ...
  template: `
    <documentation>
      ...
      <ng-container documentation-description
        >Creates a computed signal that contains all query parameters from the URL. Returns an
        object with query parameter names as keys and their values as strings.</ng-container
      >
  ...
  parameters = [
    {
      ...
      type: 'generic type',
      description:
        'Type of the query parameters object (default: { [key: string]: undefined | string })',
    },
  ];
