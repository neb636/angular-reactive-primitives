  ...
  template: `
    <documentation>
      ...
      <documentation-section>
        ...
        <code-block title="Comparing Current and Previous Values" [code]="code_usage_0" />

        <code-block title="Undo Functionality" [code]="code_usage_1" />

        <code-block title="Tracking State Transitions" [code]="code_usage_2" />
      </documentation-section>
